...
public class WorldGenRandomRubble extends WorldGenerator
{
	...
	public boolean generate(World world, Random random, int x, int y, int z)
	{
		if(random.nextInt(12) == 1)
		{
			...
			if ((world.getBlock(x, y - 1, z) == Blocks.dirt) && (!material.isSolid()) && (!material1.isSolid()) && (!material4.isSolid()) && (!material2.isSolid()) && (!material3.isSolid()) && (!material5.isSolid()) && (world.getBlock(x, y, z) == Blocks.air) && (world.getBlock(x, y + 1, z) == Blocks.air))
			{
